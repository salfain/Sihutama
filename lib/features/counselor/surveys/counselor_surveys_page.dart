        ...
        children: [
          Container(
            ...
            child: const Column(
              ...
              children: [
                Text('Angket', style: TextStyle(fontSize: 24, fontWeight: FontWeight.bold, color: Color(0xFF1E293B), letterSpacing: -0.5)),
                SizedBox(height: 4),
                Text('Kelola angket dan survei kebutuhan siswa.', style: TextStyle(fontSize: 13, color: Color(0xFF64748B))),
              ],
            ),
          ),
          Expanded(
                ...
                : _surveys.isEmpty
                    ? Center(
                        child: Column(
                          ...
                          children: [
                            Icon(Icons.poll_rounded, size: 48, color: Colors.grey.shade300),
                            const SizedBox(height: 12),
                            Text('Belum ada angket.', style: TextStyle(color: Colors.grey.shade500, fontSize: 14)),
                          ],
                        ),
                      )
                    : RefreshIndicator(
            ...
            child: Column(
              ...
              children: [
                Row(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Container(padding: const EdgeInsets.all(10), decoration: BoxDecoration(color: isActive ? Colors.green.shade50 : Colors.grey.shade100, borderRadius: BorderRadius.circular(12)), child: Icon(Icons.assignment_rounded, color: isActive ? Colors.green : Colors.grey.shade500, size: 20)),
                    const SizedBox(width: 16),
                    Expanded(
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          Text(s['title'] ?? '', style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 16, color: Color(0xFF1E293B))),
                          if ((s['description'] ?? '').toString().isNotEmpty) ...[
                            const SizedBox(height: 4),
                            Text(s['description'], style: TextStyle(fontSize: 13, color: Colors.grey.shade600, height: 1.4)),
                          ],
                        ],
                      ),
                    ),
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(color: isActive ? Colors.green.shade50 : Colors.grey.shade100, borderRadius: BorderRadius.circular(20)),
                      child: Text(isActive ? 'Aktif' : 'Nonaktif', style: TextStyle(fontSize: 11, fontWeight: FontWeight.bold, color: isActive ? Colors.green.shade700 : Colors.grey.shade600)),
                    ),
                  ],
                ),
                ...
                Row(
                  ...
                  children: [
                    _statIcon(Icons.quiz_rounded, '${s['questionCount'] ?? 0} Pertanyaan'),
                    _statIcon(Icons.people_alt_rounded, '${s['responseCount'] ?? 0} Responden'),
                  ],
                ),
              ],
            ),
  ...
  Widget _statIcon(IconData icon, String text) {
    return Row(
      children: [
        ...
        Text(text, style: TextStyle(fontSize: 12, fontWeight: FontWeight.w600, color: Colors.grey.shade600)),
      ],
    );
  }
