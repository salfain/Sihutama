...
class StudentCbtProfilPage extends ConsumerStatefulWidget {
  const StudentCbtProfilPage({super.key});
  @override
  ConsumerState<StudentCbtProfilPage> createState() => _State();
}

class _State extends ConsumerState<StudentCbtProfilPage> {
          ...
          : CustomScrollView(slivers: [
                        ...
                        Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                          ...
                          Container(
                            ...
                            child: const Row(children: [
                              ...
                              SizedBox(width: 6),
                              Text('CBT', style: TextStyle(color: Colors.white, fontSize: 11, fontWeight: FontWeight.w600)),
                            ])),
                        ]),
                        ...
                        Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            gradient: const LinearGradient(colors: [Color(0xFF60A5FA), Color(0xFF1D4ED8)],
                              begin: Alignment.topLeft, end: Alignment.bottomRight),
                            boxShadow: [BoxShadow(color: _blue.withAlpha(80), blurRadius: 16, offset: const Offset(0, 6))]),
              ...
              SliverPadding(
                ...
                sliver: SliverList(delegate: SliverChildListDelegate([
                  _infoCard(isDark, [
                    _infoRow('NIS', nis, Icons.badge_rounded, _blue, isDark),
                    _div(isDark),
                    _infoRow('Kelas', className, Icons.class_rounded, _blue, isDark),
                    _div(isDark),
                    _infoRow('Jurusan', major, Icons.school_rounded, _blue, isDark),
                  ]),
  ...
  Widget _infoCard(bool isDark, List<Widget> c) => _card(isDark, c);
  ...
  void _about(BuildContext context, bool isDark, String system) {
    showDialog(context: context, builder: (ctx) => AlertDialog(
      backgroundColor: isDark ? const Color(0xFF1E293B) : Colors.white,
      shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(20)),
      title: Text(system, style: const TextStyle(fontWeight: FontWeight.bold)),
      content: Text('Sistem $system SMK Hutama\nVersi 1.0',
