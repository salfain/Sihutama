            ...
            child: Column(
              ...
              children: [
                Container(
                  ...
                  child: Icon(Icons.lock, size: 56, color: Colors.red[700]),
                ),
                const SizedBox(height: 20),
                Text('Ujian Terkunci', style: TextStyle(fontSize: 22, fontWeight: FontWeight.bold, color: Colors.red[800])),
                ...
                Container(
                  ...
                  child: Column(children: [
                    const Icon(Icons.support_agent, size: 36, color: Color(0xFFB91C1C)),
                    const SizedBox(height: 8),
                    const Text('Hubungi Pengawas', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 15)),
                ...
                SizedBox(
                  ...
                  child: ElevatedButton.icon(
                    ...
                    style: ElevatedButton.styleFrom(backgroundColor: Colors.red[700], padding: const EdgeInsets.symmetric(vertical: 14)),
                  ),
                ),
                const SizedBox(height: 8),
                TextButton(
